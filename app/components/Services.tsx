  ...
  return (
    <div className="container my-16 space-y-4">
      ...
      <div className="text-center max-w-lg mx-auto space-y-2">
        ...
        >
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Est magni, et
          delectus obcaecati nostrum ad maxime, in voluptatem assumenda ipsam
          deleniti dolorum.
        </motion.p>
      </div>
        ...
        {ServicesData.map((service) => (
          ...
          >
            <img
              ...
              alt=""
              className="img-shadow2 max-w-48 mx-auto hover:scale-110 duration-300"
            />
